...
public:
    ...
    void moveResize(const QRectF &rect, bool immediateResize = false);
...
protected:
    ...
    virtual void moveResizeInternal(const QRectF &rect, MoveResizeMode mode, bool immediateResize = false) = 0;
